...
[_BL] = KEYMAP_ANSI(
  ...
  KC_LCTL, KC_LGUI,KC_LALT,                KC_SPC,                        KC_RALT,MO(_FBL),KC_RCTRL, KC_LEFT,KC_DOWN,KC_RGHT),
...
[_FBL] = KEYMAP_ANSI(
  ...
  TO(_IL),_______,_______,                 _______,               _______,_______,KC_APP ,KC_MS_L,KC_MS_D, KC_MS_R),



/* Keymap _IL: Inverted Layer - Number keys are Function keys by default
   * ,----------------------------------------------------------------.
   ...
   * |Shift   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /|Shift | Up|PgDn|
   * |----------------------------------------------------------------|
   * |Ctrl|Win |Alt |        Space          |Alt|FIL|Ctrl|Lef|Dow|Rig |
   * `----------------------------------------------------------------'
   */
[_IL] = KEYMAP_ANSI(
  KC_ESC, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9, KC_F10,    KC_F11,  KC_F12, KC_MINS, KC_EQL, KC_BSPC,KC_GRV, \
  MT(MOD_LCTL | MOD_LSFT, KC_TAB),  KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_LBRC, KC_RBRC,KC_BSLS,KC_DEL, \
  MT(MOD_LCTL, KC_CAPS), KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT,		KC_ENT	   ,KC_PGUP,  \
  KC_LSFT,         KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,   KC_RSFT,KC_UP,KC_PGDN, \
  KC_LCTL, KC_LGUI,KC_LALT,                KC_SPC,                        KC_RALT,MO(_FIL),KC_RCTRL, KC_LEFT,KC_DOWN,KC_RGHT),



  /* Keymap _FIL: Function Inverted Layer
   * ,----------------------------------------------------------------.
   ...
   */
[_FIL] = KEYMAP_ANSI(
  _______,   KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,KC_MINS, KC_EQL, KC_DEL, KC_INS ,  \
  _______,KC_VOLD,KC_MUTE,KC_VOLU,_______,_______,_______,_______,_______,_______,_______,_______,_______, _______,KC_HOME, \
  _______, BL_DEC,BL_TOGG, BL_INC,_______,_______,_______,_______,_______,_______,_______,_______,        _______,KC_END, \
  _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,KC_BTN1, KC_MS_U, KC_BTN2, \
  TO(_BL),_______,_______,                 _______,               _______,_______,KC_APP ,KC_MS_L,KC_MS_D, KC_MS_R),
